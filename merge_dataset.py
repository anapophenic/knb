...
if __name__ == '__main__':
    ...
    for ch in chrs:
        ...
        filename1 = 'Data_Intact/cndd/emukamel/HMM/Data/Binned/allc_AM_V8_chr' + str(ch) + '_binsize100.mat'
        filename2 = 'Data_Intact/cndd/emukamel/HMM/Data/Binned/allc_AM_V9_chr' + str(ch) + '_binsize100.mat'
        filename = 'Data_Intact/cndd/emukamel/HMM/Data/Binned/allc_AM_V_chr' + str(ch) + '_binsize100.mat'
